...
public class Style extends Object {
    ...
    public final static Property BackgroundColor = new Color.Property("background-color");
    ...
    public void applyElement(Element element,String status) {
        if(_propertyValues.containsKey(status)) {
            TreeMap<Property,Object> values = _propertyValues.get(status);
        ...
        if(_propertyValues.containsKey(status)) {
            ...
            for(Property property : values.keySet()) {
                if(property != Style || property != Status) {
                    java.lang.Object v = element.get(property);
                    element.onPropertyChanged(property, null, v);
                }
            }
        }
